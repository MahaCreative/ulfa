...
export default function Update({onClose, model}) {
    ...
    const { data, setData, put , errors, progress } = useForm({ id: '', nama_lengkap: '', jenis_kelamin: '', alamat: '', tempat_lahir: '', tanggal_lahir: '', telp: '', angkatan: '', thumbnail: model ? model.thumbnail : '' })
    const [loading, setLoading] = useState(false);
    const submitHandler = (e) => {
        e.preventDefault()
        put(route('anggota-update'), {
            onStart: () => setLoading(true), onError: () => setLoading(false), onSuccess: () => {
                setLoading(false)
                onClose()
            }
        })
          ...
          <form onSubmit={submitHandler } encType={'multipart/form-data'}>
              <div className='flex gap-3 items-center'>
                  <div>
                      <div className="my-1.5">
                          <div className='flex gap-3 items-center'>
                              ...
                              <input defaultValue={data.nama_lengkap} ref={inputRef} onChange={changeHandler} name='nama_lengkap' className='w-full rounded-md border border-emerald-500 text-emerald-400 font-fira px-4 py-1.5 outline-none focus:ring focus:ring-emerald-400/30 ' type={'text'} placeholder='Nama Lengkap' />
                          </div>
                      ...
                      <div className="my-1.5">
                          <div className='flex gap-3 items-center'>
                              ...
                              <select ref={inputRef} onChange={changeHandler} name='jenis_kelamin' className='w-full rounded-md border border-emerald-500 text-emerald-400 font-fira px-4 py-1.5 outline-none focus:ring focus:ring-emerald-400/30 '>
                                  <option defaultValue={data.jenis_kelamin} selected disabled>{data.jenis_kelamin}</option>
                      ...
                      <div className="my-1.5">
                          <div className='flex gap-3 items-center'>
                              ...
                              <textarea defaultValue={data.alamat} ref={inputRef} onChange={changeHandler} name='alamat' className='w-full rounded-md border border-emerald-500 text-emerald-400 font-fira px-4 py-1.5 outline-none focus:ring focus:ring-emerald-400/30 ' type={'text'} placeholder='Alamat' />
                          </div>
                      ...
                      <div className="my-1.5">
                          <div className='flex gap-3 items-center'>
                              ...
                              <input defaultValue={data.tempat_lahir} ref={inputRef} onChange={changeHandler} name='tempat_lahir' className='w-full rounded-md border border-emerald-500 text-emerald-400 font-fira px-4 py-1.5 outline-none focus:ring focus:ring-emerald-400/30 ' type={'text'} placeholder='Tempat Lahir' />
                          </div>
                      ...
                      <div className="my-1.5">
                          <div className='flex gap-3 items-center'>
                              ...
                              <input defaultValue={data.tanggal_lahir} ref={inputRef} onChange={changeHandler} name="tanggal_lahir" className='w-full rounded-md border border-emerald-500 text-emerald-400 font-fira px-4 py-1.5 outline-none focus:ring focus:ring-emerald-400/30 ' type={'text'} placeholder='Tanggal Lahir (31-12-2022)' />
                          </div>
                      ...
                      <div className="my-1.5">
                          <div className='flex gap-3 items-center'>
                              ...
                              <input defaultValue={data.telp} ref={inputRef} onChange={changeHandler} name='telp' className='w-full rounded-md border border-emerald-500 text-emerald-400 font-fira px-4 py-1.5 outline-none focus:ring focus:ring-emerald-400/30 ' type={'text'} placeholder='Telp' />
                          </div>
                      ...
                      <div className="my-1.5">
                          <div className='flex gap-3 items-center'>
                              ...
                              <option defaultValue={data.angkatan} selected disabled>{model.angkatan} </option>
                                  {angkatan.map((item) => (
                  ...
                  <div className=' p-3 border border-emerald-400 rounded-lg'>
                      ...
                      <p className='text-center text-emerald-400 my-3'>Images</p>
                  </div>
              </div>
