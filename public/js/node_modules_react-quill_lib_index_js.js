(self["webpackChunk"] = self["webpackChunk"] || []).push([
    ["node_modules_react-quill_lib_index_js"],
    {
...
*/
        ...
        */
                        ...
                        _this.onEditorChange = function (
                            ...
                            if (eventName === "text-change") {
                                (_b = (_a = _this).onEditorChangeText) ===
                                    null || _b === void 0
                                    ? void 0
                                    : _b.call(
                                          _a,
                                ...
                                (_d = (_c = _this).onEditorChangeSelection) ===
                                    null || _d === void 0
                                    ? void 0
                                    : _d.call(
                                          _c,
                    ...
                    ReactQuill.prototype.validateProps = function (props) {
                        ...
                        if (react_1.default.Children.count(props.children)) {
                            var child = react_1.default.Children.only(
                                props.children
                            );
                            if (
                                ((_a = child) === null || _a === void 0
                                    ? void 0
                                    : _a.type) === "textarea"
                            )
                                throw new Error(
                    ...
                    ReactQuill.prototype.shouldComponentUpdate = function (
                        nextProps,
                        nextState
                    ) {
                        var _this = this;
                        ...
                        if ("value" in nextProps) {
                            ...
                            if (
                                !this.isEqualValue(nextContents, prevContents)
                            ) {
                        ...
                        return __spreadArrays(
                            ...
                            return !isEqual_1.default(
                                nextProps[prop],
                                _this.props[prop]
                            );
                        });
                    };
                    ReactQuill.prototype.shouldComponentRegenerate = function (
                        nextProps
                    ) {
                        var _this = this;
                    ...
                    ReactQuill.prototype.componentDidUpdate = function (
                        prevProps,
                        prevState
                    ) {
                        var _this = this;
                        ...
                        if (
                            this.editor &&
                            this.shouldComponentRegenerate(prevProps)
                        ) {
                        ...
                        if (this.state.generation !== prevState.generation) {
                            ...
                            postpone(function () {
                                return _this.setEditorSelection(
                                    editor_1,
                                    selection_1
                                );
                            });
    ...
    */
                    ...
                    ReactQuill.prototype.getEditor = function () {
                        if (!this.editor)
                            throw new Error(
                                "Accessing non-instantiated editor"
                            );
                        return this.editor;
                    };
                    /**
    ...
    */
                    ReactQuill.prototype.createEditor = function (
                        element,
                        config
                    ) {
    ...
    */
                    ReactQuill.prototype.isEqualValue = function (
                        value,
                        nextValue
                    ) {
    ...
    */
                    ReactQuill.prototype.setEditorContents = function (
                        editor,
                        value
                    ) {
                        var _this = this;
                    ...
                    ReactQuill.prototype.setEditorSelection = function (
                        editor,
                        range
                    ) {
                        ...
                        if (range) {
                            ...
                            range.index = Math.max(
                                0,
                                Math.min(range.index, length_1 - 1)
                            );
                            range.length = Math.max(
                                0,
                                Math.min(
                                    range.length,
                                    length_1 - 1 - range.index
                                )
                            );
                            editor.setSelection(range);
                        }
                    };
                    ReactQuill.prototype.setEditorTabIndex = function (
                        editor,
                        tabIndex
                    ) {
                        var _a, _b;
                        if (
                            (_b =
                                (_a = editor) === null || _a === void 0
                                    ? void 0
                                    : _a.scroll) === null || _b === void 0
                                ? void 0
                                : _b.domNode
                        ) {
                    ...
                    ReactQuill.prototype.setEditorReadOnly = function (
                        editor,
                        value
                    ) {
                        if (value) {
    ...
    */
                    ...
                    ReactQuill.prototype.getEditingArea = function () {
                        if (!this.editingArea) {
                            throw new Error(
                                "Instantiating on missing editing area"
                            );
                        }
                        var element = react_dom_1.default.findDOMNode(
                            this.editingArea
                        );
                        if (!element) {
                            throw new Error(
                                "Cannot find element for editing area"
                            );
                        }
                        if (element.nodeType === 3) {
                            throw new Error(
                                "Editing area cannot be a text node"
                            );
                        }
                        return element;
                    };
    ...
    */
                    ...
                    ReactQuill.prototype.onEditorChangeText = function (
                        ...
                        if (nextContents !== this.getEditorContents()) {
                            ...
                            (_b = (_a = this.props).onChange) === null ||
                            _b === void 0
                                ? void 0
                    ...
                    ReactQuill.prototype.onEditorChangeSelection = function (
                        ...
                        (_b = (_a = this.props).onChangeSelection) === null ||
                        _b === void 0
                            ? void 0
                            : _b.call(_a, nextSelection, source, editor);
                        if (hasGainedFocus) {
                            (_d = (_c = this.props).onFocus) === null ||
                            _d === void 0
                                ? void 0
                                : _d.call(_c, nextSelection, source, editor);
                        } else if (hasLostFocus) {
                            (_f = (_e = this.props).onBlur) === null ||
                            _f === void 0
                                ? void 0
